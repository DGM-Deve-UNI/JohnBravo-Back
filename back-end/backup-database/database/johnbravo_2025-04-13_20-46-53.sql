...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabela de cadastro de usuários.';
...
INSERT INTO `usuarios` VALUES (20,'Lia','Almeida','2000-12-12','Feminino','049.996.453-51','lia@g.com','(21) 88888-8888','(21) 9999-9999','20911-302','Comunidade Urbana MANDELA DE PEDRA','33','RJ','Rio de Janeiro','Manguinhos','','lia12345','$2y$10$Pwp7f2FJq8zJUv/CXiukUe.ysdhIDVnwcu/L8GapUECHpi.dqfbNW'),(21,'Luna','Pires','2000-12-12','Feminino','123.456.789-09','luna@g.com','(21) 91234-5678','','20911-300','Rua Leopoldo Bulhões','01','RJ','Rio de Janeiro','Manguinhos','','luna1234','$2y$10$zNizWTMP8A03TawLMYhQKeiFgRy9.v4s1F64YGG9jHpxTu5jMzEBu');
...
-- Dump completed on 2025-04-13 20:46:53
