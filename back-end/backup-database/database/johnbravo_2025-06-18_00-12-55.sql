...
CREATE TABLE `assinatura` (
  ...
  KEY `fk_assinatura_usuario` (`id_usuario`),
  CONSTRAINT `fk_assinatura_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_user`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabela de assinaturas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `assinatura` VALUES (1,'qwe','qwe','\"[{\\\"nome\\\":\\\"qwe\\\",\\\"ativo\\\":1},{\\\"nome\\\":\\\"sad\\\",\\\"ativo\\\":0}]\"',123.00,1,NULL),(2,'Teste 1','','\"[{\\\"nome\\\":\\\"Servi\\u00e7o 1\\\",\\\"ativo\\\":1},{\\\"nome\\\":\\\"Servi\\u00e7p 2\\\",\\\"ativo\\\":0}]\"',100.00,1,NULL);
/*!40000 ALTER TABLE `assinatura` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `assinatura_servico`
--

DROP TABLE IF EXISTS `assinatura_servico`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `assinatura_servico` (
  ...
  KEY `id_servico` (`id_servico`),
  CONSTRAINT `assinatura_servico_ibfk_1` FOREIGN KEY (`id_assinatura`) REFERENCES `assinatura` (`id_assinatura`) ON DELETE CASCADE,
  CONSTRAINT `assinatura_servico_ibfk_2` FOREIGN KEY (`id_servico`) REFERENCES `servico` (`id_servico`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `assinatura_servico`
--

LOCK TABLES `assinatura_servico` WRITE;
/*!40000 ALTER TABLE `assinatura_servico` DISABLE KEYS */;
/*!40000 ALTER TABLE `assinatura_servico` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `funcionario` (
  ...
  `status` enum('Ativo','Férias','Afastado','Inativo') NOT NULL DEFAULT 'Ativo',
  `foto` longblob DEFAULT NULL,
  PRIMARY KEY (`id_funcionario`),
  UNIQUE KEY `email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Tabela de funcionários';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `funcionario` VALUES (15,'João Silva','Barbeiro Sênior','21988765343','joao@g.com','Férias',NULL),(18,'qweqwe','Barbeiro','qweqwe','qweqwe','Afastado',''),(19,'wefwefw','Barbeiro','12123123123','123123123@gail.com','Ativo',NULL);
...
CREATE TABLE `usuario` (
  ...
  `data_cadastro_user` datetime DEFAULT current_timestamp(),
  PRIMARY KEY (`id_user`),
...
-- Dump completed on 2025-06-18  0:12:55
